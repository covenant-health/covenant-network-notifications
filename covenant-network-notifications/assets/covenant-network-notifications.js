...
(function ($) {
  $(document).ready(function () {
    $('.system-notification-wrapper ul').each(function (i, el) {
      ...
      .addClass('dropdown-menu notification-menu') // Add the aria-labelledby attr
      ...
      var listWidth = $('.notification-menu').width(),
      ...
      $('.notification-menu').css('width', $(this).width()); // Finally, if the page is viewed within an iframe…
